...
public interface RemoteStudentSports extends Remote{
    ...
    void addParticipantToSportClass(SportClass sportClass, Member member) throws RemoteException, SQLException;
